export type NextChapterQuestion = {
  id: number;
  text: string;
  options: string[];
};

export type NextChapterSection = {
  title: string;
  startId: number;
  questions: NextChapterQuestion[];
};

export const nextChapterSections: NextChapterSection[] = [
  {
...
export const careerJobSearchQuestionBank = nextChapterSections.flatMap(
