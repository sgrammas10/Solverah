export type YourFutureQuestion = {
  id: number;
  text: string;
  options: string[];
};

export const yourFutureYourWayIntro = {
...
export const yourFutureYourWayQuestions: YourFutureQuestion[] = [
  {
    id: 1,
  ...
  },
  {
    ...
    options: ["Successful", "Creative", "Smart", "Kind"],
  },
  {
    id: 17,
...
export const yourFutureYourWayQuestionBank = yourFutureYourWayQuestions;
